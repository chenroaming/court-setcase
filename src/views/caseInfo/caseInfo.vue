...
<template>
<div>
    <div v-show="nexts" style="padding:10px;padding-top:20px;padding-bottom:20px;height:100%">
        ...
        <div class="content_main">
             <Form :model="addFormItem" :label-width="100" inline v-show="success">
                ...
                <FormItem label="标的金额" style="width: 405px;position: relative;" >
                    <input type="text" name="je"   @input="clearNoNum"  style="    width: 100%;
    border: 1px solid #dddee1;
    border-radius: 5px;
    padding-left: 5px;"/><span style="color:#495060;position: absolute;top: 2px;
    right: 10px;">元</span>
...
delEvidence,
briefMenu,
saveEvidence,getContacts} from '@/api/caseInfo.js';
            ...
            optCommonPerson(this.usualId,this.caseId,this.statusNow).then(res => {
                if(res.data.state == 100){
                    ...
                    const data={
                        ...
                        type:tem.litigantType==0 ? "自然人" : (item.litigantType==1 ? "法人" : "非法人组织"),
